...
bool Adafruit_MPU6050::getEventRaw(uint16_t* info_buffer)
{
  ...
  info_buffer[0] = buffer[0] << 8 | buffer[1];
  info_buffer[1] = buffer[2] << 8 | buffer[3];
  info_buffer[2] = buffer[4] << 8 | buffer[5];

  info_buffer[3] = buffer[8] << 8 | buffer[9];
  info_buffer[4] = buffer[10] << 8 | buffer[11];
  info_buffer[5] = buffer[12] << 8 | buffer[13];
